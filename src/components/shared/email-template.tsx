...
export function getVerifyEmailHtml(email: string, verifyUrl: string): string {
  return `
    <!DOCTYPE html>
    <html>
    <head>
          ...
          <td align="center">
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
              ...
              <tr>
                <td style="padding: 0 40px 30px 40px;">
                  <p style="margin: 0 0 20px 0; font-size: 16px; line-height: 24px; color: #52525b;">
                    Welcome! Before getting started, please confirm this is really your email address (<strong>${email}</strong>).
                  </p>
                  <p style="margin: 0 0 30px 0; font-size: 16px; line-height: 24px; color: #52525b;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td align="center" style="padding: 0 0 30px 0;">
                        <a href="${verifyUrl}" style="display: inline-block; padding: 14px 32px; background-color: #18181b; color: #ffffff; text-decoration: none; border-radius: 6px; font-size: 16px; font-weight: 500;">Verify Email</a>
                      </td>
                    </tr>
                  </table>
